...
public class Sell_inform_thread extends AsyncTask<Void,Void, Void> {
	...
	public void setBookSell_inform(String Subject,String Title,String Writer, String publisher,String Price,String Quality,String PhoneNum){	
	...
	private boolean HttpFileUpload(String urlString) {
		try {
			FileInputStream mFileInputStream = new FileInputStream(new File(filepath));			
