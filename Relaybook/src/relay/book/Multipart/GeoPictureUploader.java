...
public class GeoPictureUploader {
	...
	public GeoPictureUploader(String Subject, String Title, String Writer,
	...
	private void writeFormField(String fieldName, String fieldValue) {
		try {
			...
			dataStream.writeUTF(fieldValue); // 파라미터의 값은 한글이 올수도 있으므로 UTF-8로
												// 변환하여 저장해주면 서버에서 받을때 한글이 깨지지
												// 않고 출력된다.
			dataStream.writeBytes(CRLF);
	 ...
	 */
	private void writeFileField(String fieldName, String fieldValue,
			String type, FileInputStream fis) {
		try {
